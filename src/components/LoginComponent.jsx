...
function LoginPage() {
    return (
<div class=" bg-slate-200 grid h-screen ">
    <div class="">
    <div class="max-w-lg mx-auto my-16 bg-white p-8 rounded-xl shadow shadow-slate-300 ">
        <h1 class="text-4xl text-center font-medium mb-4">Login</h1>
        <p class="text-slate-500 text-center">Halo 👋<br/>Selamat Datang di Klinik </p>
